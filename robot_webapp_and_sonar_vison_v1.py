...
# Application allows display sonar and servo position
# User can move camera up, down, left and right
# I am implementing vision system
        ...
        while True:    
            ...
            if dist > 10:
                ...
                def moveVerticalServoRightRoute(positionVerticalCamera = "Right", post_id=None):
                    ...
                    '''
                # RoOUTE MEASURE DISTANCE USING SONAR
                @app.route('/measure-distance-sonar') 
                def measureDistanceSonar(dist=dist, post_id=None):
                    print("Measure distance robot from the obstacle ")
                    dist = int(distance())
                    print(dist)
                    return render_template('./camera.html', dist=dist)
